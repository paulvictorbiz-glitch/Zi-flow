...
async function downloadAgentFiles(personId) {
  ...
  // Self-diagnosing installer: never exits silently, prints PASS/FAIL per step
  // and a final summary the user can screenshot. The most common new-user
  // failure is the browser/SmartScreen removing or blocking the EXE — this
  // script detects that explicitly instead of doing nothing.
  const bat = [
    "@echo off",
          ...
          {installOpen && (
            <div style={{ marginTop: 10, display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <div style={{ fontSize: 11.5, color: "var(--fg)", lineHeight: 1.7 }}>
                ...
                <b> Right-click the .zip → Properties → Unblock</b> before extracting, then unzip it
                somewhere permanent (not a synced/Downloads folder) and double-click <code>install.bat</code>.
                The installer runs a self-test and prints a PASS/FAIL summary — if anything is blocked,
                screenshot that summary and send it to Paul.
              </div>
